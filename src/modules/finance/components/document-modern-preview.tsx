...
export function DocumentModernPreview({
    data,
    type,
    token,
    signatureSlot,
    ...
    const heroDescMap = {
        ...
        invoice: "Dưới đây là chi tiết các hạng mục cần thanh toán. Quý khách vui lòng kiểm tra thông tin và tiến hành thanh toán theo hướng dẫn đính kèm."
    };

    const totalLabelMap = {
        quotation: "Tổng báo giá",
        contract: "Tổng hợp đồng",
        invoice: "Tổng hóa đơn"
    };
                    ...
                    <div className="space-y-7">
                        ...
                        <div className="overflow-hidden rounded-2xl border border-[#eaeaea] bg-white">
                            <div className="relative overflow-hidden p-5">
                                <h3 className="inline-flex w-fit rounded-md border border-amber-200 bg-amber-50 px-3 py-2 text-[15px] font-medium uppercase tracking-[0.06em] text-amber-700">Bên A - Đơn vị cung cấp</h3>
                            ...
                            <div className="relative overflow-hidden border-t border-[#eaeaea] p-5">
                                <h3 className="inline-flex w-fit rounded-md border border-amber-200 bg-amber-50 px-3 py-2 text-[15px] font-medium uppercase tracking-[0.06em] text-amber-700">Bên B - Khách hàng</h3>
                                <div className="relative mt-4">
                                    ...
                                    <table className="w-full min-w-[820px] table-fixed border-collapse">
                                        <thead>
                                            <tr className="bg-white text-[15px] font-normal tracking-[-0.005em] text-gray-500">
                                                <th className="w-[38%] whitespace-nowrap border-b border-r border-[#e5e7eb] px-5 py-4 text-left font-normal">Nội dung dịch vụ</th>
