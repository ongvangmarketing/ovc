...
export function CourseTable({ courses }: { courses: TrainingTypes.TrainingCourseRow[] }) {
...
export function StudentTable({ students }: { students: TrainingTypes.TrainingStudentRow[] }) {
...
export function PotentialStudentTable({ students }: { students: TrainingTypes.TrainingPotentialStudentRow[] }) {
...
export function ClassTable({ classes }: { classes: TrainingTypes.TrainingClassRow[] }) {
...
export function TuitionTable({ tuition }: { tuition: TrainingTypes.TrainingTuitionRow[] }) {
...
export function InstructorTable({ instructors }: { instructors: TrainingTypes.TrainingInstructorRow[] }) {
...
export function ScheduleTable({ schedules }: { schedules: TrainingTypes.TrainingScheduleRow[] }) {
...
export function CertificateTable({ certificates }: { certificates: TrainingTypes.TrainingCertificateRow[] }) {
