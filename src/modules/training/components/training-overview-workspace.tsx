...
import type { OverviewClass, OverviewCourse, OverviewStudent, OverviewTab, TrainingOverviewData } from "../types/training-overview.types";
import { mockOverviewData } from "../types/training-overview.mock";
import { OverviewHeader } from "./overview-header";
import { OverviewStatCards } from "./overview-stat-cards";
import { OverviewAlertPanel } from "./overview-alert-panel";
import { OverviewQuickActions } from "./overview-quick-actions";
import { OverviewCourseTable } from "./overview-course-table";
import { OverviewClassGrid } from "./overview-class-grid";
import { OverviewStudentList } from "./overview-student-list";
import { MobileItemDrawer, OverviewItemDrawer } from "./overview-item-drawer";
import { OverviewQuickCreate } from "./overview-quick-create";
  ...
  return (
    <div className="page-container mx-auto max-w-7xl space-y-5">
      ...
      <nav
        ...
        className="flex gap-2 overflow-x-auto rounded-2xl border border-[#eaeaea] bg-white p-2"
      >
        {tabs.map((tab) => {
          const Icon = tab.icon;
          ...
          return (
            <button
              ...
              className={cn(
                "relative inline-flex shrink-0 items-center gap-2 rounded-lg px-4 py-2 text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-gray-100",
