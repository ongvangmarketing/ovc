  ...
  return (
    <div className="w-full max-w-4xl mx-auto">
      ...
      <h1 className="text-3xl md:text-[40px] font-normal tracking-tight mb-4">
        <span className="text-black font-medium">Chào mừng trở lại,</span> <span className="text-slate-400">tiếp tục công việc của bạn.</span>
      </h1>
      ...
      <div className="rounded-[24px] border border-slate-200 bg-white p-8 md:p-10 shadow-sm max-w-[480px]">
        <div className="mb-8">
          <h2 className="text-xl font-semibold text-black">Đăng nhập tài khoản</h2>
          <p className="mt-1 text-sm text-slate-500">Sử dụng email và mật khẩu của bạn để truy cập.</p>
        </div>
