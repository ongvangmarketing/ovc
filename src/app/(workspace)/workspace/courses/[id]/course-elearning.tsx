...
import { createCourseLesson, createCourseSection, createLessonSchedule } from "@/modules/training/actions/training.actions";
...
type CourseWithLearning = NonNullable<Awaited<ReturnType<typeof import("@/modules/training/services/training.service").TrainingService.getTrainingCourseDetail>>>;
...
export function CourseElearning({ course, options }: { course: CourseWithLearning; options: TrainingTypes.TrainingFormOptions }) {
