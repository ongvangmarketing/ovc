...
import { createTrainingTuition } from "@/modules/training/actions/training.actions";
...
export default async function CreateTuitionPage({
  ...
  const [{ studentId }, options] = await Promise.all([searchParams, TrainingService.getTrainingFormOptions()]);
