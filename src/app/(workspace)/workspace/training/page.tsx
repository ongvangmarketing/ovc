...
import { TrainingOverviewWorkspace } from "@/modules/training/components/training-overview-workspace";
import type { OverviewAlert, OverviewClass, OverviewCourse, OverviewStat, OverviewStudent, TrainingOverviewData } from "@/modules/training/types/training-overview.types";
...
export default async function TrainingPage() {
  ...
  try {
    const data = await TrainingService.getTrainingOverview();
    const now = Date.now();
