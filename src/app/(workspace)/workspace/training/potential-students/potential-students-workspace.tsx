...
function toLeadView(item: TrainingTypes.TrainingPotentialStudentRow, index: number): PotentialLeadView {
...
export function PotentialStudentsWorkspace({ initialStudents }: { initialStudents: TrainingTypes.TrainingPotentialStudentRow[] }) {
