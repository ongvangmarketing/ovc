...
import { getPaymentReceiptData } from "@/modules/finance/services/payment.service";
...
export default async function PaymentReceiptPage({ params }: ReceiptPageProps) {
  ...
  const payment = await getPaymentReceiptData(session.organizationId, id);
        ...
        <header className="receipt-top">
          <div className="receipt-brand">
            ...
            <div>
              ...
              <div className="receipt-company-line">Mã số thuế: {organizationTaxCode || "Đang cập nhật"}</div>
