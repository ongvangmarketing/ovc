  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-8 shadow-sm text-center">
        ...
        <h3 className="text-[15px] font-medium text-gray-900 mb-2">Chưa cấu hình Nguồn dữ liệu</h3>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-3xl mx-auto">
          <div className="border border-gray-200 rounded-xl p-4 hover:border-indigo-300 hover:shadow-md transition cursor-pointer text-left">
             <div className="w-10 h-10 rounded-lg bg-blue-50 text-blue-600 flex items-center justify-center mb-3">
               <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.469h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.469h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
             </div>
             <h4 className="font-medium text-gray-900">Facebook Lead Ads</h4>
          ...
          <div className="border border-gray-200 rounded-xl p-4 hover:border-indigo-300 hover:shadow-md transition cursor-pointer text-left">
             ...
             <h4 className="font-medium text-gray-900">API Webhook</h4>
          ...
          <div className="border border-gray-200 rounded-xl p-4 hover:border-indigo-300 hover:shadow-md transition cursor-pointer text-left">
             ...
             <h4 className="font-medium text-gray-900">Nhập từ Excel</h4>
      ...
      {sources.length > 0 && (
         <div className="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm">
           <div className="p-4 border-b border-gray-100">
             <h3 className="font-medium text-gray-900">Nguồn đang hoạt động</h3>
           </div>
