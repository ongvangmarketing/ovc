...
export function CourseForm({ action, course, options }: { action: Action; course?: Course | null; options: TrainingFormOptions }) {
  return (
...
export function ClassForm({ action, item, options }: { action: Action; item?: (Class & { courseId: string }) | null; options: TrainingFormOptions }) {
  return (
...
export function TuitionForm({ action, enrollment, options }: { action: Action; enrollment?: (Enrollment & { course?: { id: string; title: string; price: unknown }; student?: { id: string; name: string; email: string }; class?: { id: string; name: string } | null }) | null; options: TrainingFormOptions }) {
