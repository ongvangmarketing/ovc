    ...
    <section className="rounded-2xl border border-slate-100 bg-white shadow-sm">
      ...
      <div className="flex flex-wrap items-center gap-2 border-b border-slate-100 p-4">
        <div className="flex items-center gap-2">
          <h2 className="text-base font-bold text-slate-950">Học viên</h2>
        ...
        <div className="ml-auto flex flex-wrap items-center gap-2">
          ...
          <label className="inline-flex h-9 items-center gap-1.5 rounded-xl border border-slate-200 bg-slate-50 px-3 text-sm font-semibold text-slate-600">
      ...
      {!filtered.length && (
        ...
        >
          ...
          <p className="font-semibold text-slate-700">Không tìm thấy học viên</p>
                    ...
                    >
                      <td className="px-4 py-3.5">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <strong className="block font-semibold text-slate-950">{student.name}</strong>
                            <span className="text-xs text-slate-500">{student.email}</span>
                          </div>
                        </div>
                      </td>
                      <td className="px-4 py-3.5">
                        <span className={cn("inline-flex items-center gap-1.5 rounded-full px-2.5 py-1 text-xs font-bold", cfg.tone)}>
                      ...
                      <td className="px-4 py-3.5">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-xs font-semibold text-slate-700">{student.progress}%</span>
                        </div>
                      </td>
      ...
      {filtered.length > 0 && (
        <div className="flex items-center justify-between border-t border-slate-100 px-4 py-3">
          ...
          <Link href="/workspace/training/students" className="text-xs font-semibold text-orange-600 transition hover:underline">
            Xem tất cả →
          </Link>
        </div>
      )}
