...
export default async function OngVangNewPage() {
  const organization = await db.organization.findUnique({ where: { slug: "ongvangcomvn" } })
    ?? await db.organization.findFirst({ where: { name: { contains: "Ong Vàng", mode: "insensitive" } } })
