 ...
 */
/**
 * Be Vietnam Pro — font brand cho site public, tối ưu tiếng Việt
 * Bebas Neue — chỉ dùng cho chữ ghosted BG trang trí
 */
const BE_VIETNAM_PRO = '"Be Vietnam Pro", -apple-system, BlinkMacSystemFont, "SF Pro Display", "SF Pro Text", "Segoe UI", Roboto, sans-serif';
...
export default async function OngvangcomvnMainLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <>
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Be+Vietnam+Pro:ital,wght@0,300;0,400;0,500;0,560;0,600;0,700;0,800;0,900;1,400&family=Bebas+Neue&display=swap');
        .ongvangcomvn-site {
          font-size: 16px;
          font-weight: 400;
        ...
        .ongvangcomvn-site h6 {
          font-weight: 560 !important;
          letter-spacing: -0.045em !important;
          text-wrap: balance;
        }
        .ongvangcomvn-site h1 { font-size: 40px !important; line-height: 1.04 !important; }
        .ongvangcomvn-site h2 { font-size: 36px !important; line-height: 1.08 !important; }
        .ongvangcomvn-site h3 { font-size: 30px !important; line-height: 1.12 !important; }
        .ongvangcomvn-site h4 { font-size: 26px !important; line-height: 1.16 !important; }
        .ongvangcomvn-site h5 { font-size: 22px !important; line-height: 1.18 !important; }
        .ongvangcomvn-site h6 { font-size: 18px !important; line-height: 1.22 !important; }
        .ongvangcomvn-site .ongvangcomvn-hero-title { font-size: 88px !important; line-height: 0.98 !important; font-weight: 560 !important; }
        .ongvangcomvn-site .ongvangcomvn-page-title { font-size: 68px !important; line-height: 1.04 !important; font-weight: 560 !important; }
        .ongvangcomvn-site .ongvangcomvn-section-title { font-size: 50px !important; line-height: 1.06 !important; font-weight: 560 !important; }
        .ongvangcomvn-site .ongvangcomvn-card-title { font-size: 34px !important; line-height: 1.12 !important; font-weight: 560 !important; }
        .ongvangcomvn-site .ongvangcomvn-feature-title { font-size: 38px !important; line-height: 1.1 !important; font-weight: 560 !important; }
        .ongvangcomvn-site .ongvangcomvn-solutions-title { font-size: 44px !important; line-height: 1.06 !important; font-weight: 560 !important; }
        .ongvangcomvn-site :where(a, button) {
          font-feature-settings: "kern" 1;
        }
        .ongvangcomvn-site :where([class*="uppercase"], [class*="tracking-widest"]) {
          letter-spacing: 0.11em;
        }
        .ongvangcomvn-site :where(.text-gray-500, .text-gray-400) {
          color: #6b7280;
        }
        ...
        @media (max-width: 767px) {
          ...
          .ongvangcomvn-site .ongvangcomvn-solutions-title { font-size: 36px !important; line-height: 1.08 !important; font-weight: 560 !important; }
