...
import { askStudentQuestion } from "@/app/student/actions";
...
export default async function StudentMessagesPage() {
  ...
  const questions = await db.activityLog.findMany({
    where: { organizationId: session.organizationId, userId: session.user.id, entity: "LearningQuestion" },
