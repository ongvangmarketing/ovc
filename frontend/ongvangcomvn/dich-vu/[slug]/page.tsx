    ...
    <>
      <section className="relative overflow-hidden bg-[#f8f6f2] pt-40 pb-20">
        <div className="pointer-events-none absolute inset-x-0 top-2 hidden justify-center overflow-hidden select-none md:flex" aria-hidden>
          <span className="ongvangcomvn-solutions-ghost whitespace-nowrap text-[18vw] font-normal uppercase leading-none" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>DICH VU</span>
        </div>
        <div className="relative z-10 mx-auto max-w-7xl px-6">
          ...
          <OngvangcomvnReveal>
            ...
            <h1 className="ongvangcomvn-page-title max-w-4xl tracking-[0] text-slate-950">{toVietnameseLabel(service.name)}</h1>
      ...
      <section className="bg-white py-20">
        <div className="mx-auto grid max-w-7xl gap-6 px-6 lg:grid-cols-[1fr_360px]">
                ...
                <article className="rounded-2xl border border-orange-100 bg-white p-6 shadow-sm transition hover:border-orange-200 hover:shadow-md">
                  <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                    <div>
                      ...
                      <h2 className="ongvangcomvn-card-title mt-2 text-slate-950">{toVietnameseLabel(option.name)}</h2>
          ...
          <aside className="h-fit rounded-2xl bg-[#f8f6f2] p-6 shadow-sm">
            ...
            <h2 className="ongvangcomvn-card-title mt-4 text-slate-950">Cần tư vấn gói phù hợp?</h2>
