  ...
  return (
    <>
      ...
      <section className="bg-white py-20">
        <div className="mx-auto max-w-7xl px-6">
          <div className="mb-10 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <OngvangcomvnReveal>
              <h2 className="ongvangcomvn-section-title text-slate-900">
      ...
      <section className="bg-white py-20 text-center">
        <OngvangcomvnReveal><h2 className="ongvangcomvn-section-title text-slate-900">Chưa biết chọn khóa nào?</h2></OngvangcomvnReveal>
        <OngvangcomvnReveal delay={0.1}><p className="mt-3 text-slate-500">Để lại thông tin — chuyên gia sẽ tư vấn lộ trình phù hợp nhất.</p></OngvangcomvnReveal>
        <OngvangcomvnReveal delay={0.2}>
